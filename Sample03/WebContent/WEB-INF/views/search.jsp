...
.back { width:100px; height: 30px; text-align: center; transition:all 0.2s ease-in-out; 
line-height: 30px;border: 1px solid; float:right; background: #000; color:#fff; cursor:pointer;}
...
$("#choice").val('<%=request.getParameter("choice")%>');
